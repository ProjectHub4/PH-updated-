...
<br><br>
    ...
    <br><br>
        ...
        <button class="button" onclick="location.href='home.php';" value="Back" ><span>Cancel</span> </button><br><br>
...
<?php
    ...
    $query="INSERT INTO project_form (projectid,projecttitle,student1,student2,student3,student4,batch,year,supervisor) VALUES('$projectid', '$projecttitle', '$student1', '$student2', '$student3', '$student4', '$batch','$year','$supervisor')";
