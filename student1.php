...
<body>
   ...
   <div class="main" >
            <div class="topbar">
                ...
                <h1><b> ADMIN PANEL-STUDENTS</b> </h1>
            ...
            <div class="details" >
                <div class="recentOrders" style="background-color:#f5f5f5;">
                    <div class="cardHeader">
                        <h2><b>Enter Student</b></h2>
                       <a href="http://localhost/project/enroll%20student.php">
                        <button class="button" style="vertical-align:middle" ><span>+Enroll Students</span> </button>
                        </a>
...
<table>
                        ...
                        <thead>
                            ...
                            <tr style="background-color: #A9A6CE;">
                                ...
                                <td><center><b>ENROLMENT</b></center></td>
					...
					while($row=mysqli_fetch_array($query)){
						...
						<tr>
                            ...
                            <td><center><?php echo $row['enrolment']; ?><center></td>
                            <td><center><?php echo $row['batch']; ?><center></td>
                            <td><center><?php echo $row['year']; ?><center></td>
							<td>
								<b><center><a href="edit1.php?id=<?php echo $row['id']; ?>">Edit</a><center></b>
                                </td>
                                <td>
								<b><center><a href="delete1.php?id=<?php echo $row['id']; ?>">Delete</a><center></b>
							</td>
						</tr>
                        <?php $count++; } ?>
						<?php
